        ...
        <div class="breather">
            <div class="emphasis-block">
                ...
                <p>If the page check shows that we can make a copy for you, based on the information you've provided us
                    ...
                    email you to explain why we are not able to make a copy. If you choose to go ahead with your order,
                    you can decide whether you would like to receive a digital copy via email, or a hard copy or CD Rom
                    by post.
                </p>
            </div>
            <?php require_once('progress-tabs.php'); ?>
        </div>
    </div>
</section>
